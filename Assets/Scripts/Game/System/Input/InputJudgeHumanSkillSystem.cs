...
public class InputJudgeHumanSkillSystem:ReactiveSystem<InputEntity>,IInitializeSystem
{
    ...
    protected  override void Execute(List<InputEntity> entities)    
    {
        foreach (var entity in entities)
        {
            ...
            var timer = timerService.CreateTimer(Const.TimerId.HUMAN_SKILL_TIMER, 0.1f, false);
            if (timer == null)
            {
                timer = timerService.ResetTimerData(Const.TimerId.HUMAN_SKILL_TIMER, 0.1f, false);
