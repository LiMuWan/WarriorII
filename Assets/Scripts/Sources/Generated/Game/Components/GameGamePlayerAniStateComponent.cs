...
public partial class GameEntity {
    ...
    public void AddGamePlayerAniState(Const.PlayerAniIndex newPlayerAniIndex) {
        ...
        component.PlayerAniIndex = newPlayerAniIndex;
        AddComponent(index, component);
    }

    public void ReplaceGamePlayerAniState(Const.PlayerAniIndex newPlayerAniIndex) {
        var index = GameComponentsLookup.GamePlayerAniState;
        var component = (Game.PlayerAniState)CreateComponent(index, typeof(Game.PlayerAniState));
        component.PlayerAniIndex = newPlayerAniIndex;
